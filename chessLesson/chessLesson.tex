...
\def\BookTitle{The Art of}
\def\BookSubtitle{Not Losing}
...
\input{uncertainty/main}
\input{acceptance/main}
\input{things-dont-change/main}
\input{objective-by-objective/main}
\input{persistence-and-redemption/main}
\input{resourcefulness/main}
