...
\begin{multicols}{2}
    \newchessgame
    \chessgameinfo{World Chess Championship}{M.Carlsen}{W.Anand}{}{}{1-0}
    \mainline[level=1]{
    ...
    \mythoughts{
        ...
        \variation{13. d4 exd4 14. Nd4} hitting c6 and f5. It looks good for me.
    ...
    \myreflection{
        ...
        I was mixing ideas from the game Carlsen vs. Wang Hao. 
        % TODO add fen here for the game!!

        A more subtle approach is to focus on the opponent's weaknesses:
        tie the opponent down to one weakness, then strike somewhere else where the defense
    ...
    \myreflection{
        Yes, I found the move like Carlsen!
    }
    ...
    \mythoughts{
        I decide to play \variation{21. exf5}. It drives the knight away. A pawn
