...
An warm-up exercise. What must Black play? We can use Process of Elimination here.
...
How to continue the attack here? Black is threatening taking the 
rook on d1. Moving the knight to e3 to protect the rook and at 
the same time make room on g4 for her pawn is natural.

\mainline{ 4. Ne3 } 

\chessboard

Again, Black must decide how to defend here. The candidates moves 
...
Then we have now only \variation[invar]{4... Rxd1} left.
\mainline{4...Rxd1 }
    ...
    Choose a right move is still not easy here. Understanding White has \symknight g4 as resource,
    ...
    We go back to the mainline. In the game Voronova decides to develop her knight.
    \mainline[level=1]{5... Nd6 6. Rd5+} 
    
    \chessboard

    We arrive the deciding moment of the game. How should Black defend using Process of Elimination?
    ...
    In the game, Black Voronova is unable to bear the tension, plays \variation[invar]{6...f5} and loses
    quickly. What would happen, if she plays \variation[invar]{6...e5}?
    ...
    White threats also \variation[invar]{8. g4 Kh4 9. Qh6#}. The defense is natural.
    ...
    White must must her queen. d7 is a good square.
    ...
    White threats to play \variation[invar]{10. Ng2+ Kh3 11. Rd3#}. To defend the 
