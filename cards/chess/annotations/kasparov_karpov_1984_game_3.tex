...
\begin{multicols}{2}
  \chessgameinfo{World Championship}{Karpov, Anatoly}{Kasparov, Garry}{3}{1984.01.24}{1-0}
\newchessgame[
 id=main,
...
Black has a weakness on b6. The next moves of White are logical, attacking 
...
he can stop Black from playing d5. With White's next move, he stops both the b5 and d5 breaks.
...
The b6 pawn is under attack. \variation[invar]{12... Nd7} is a natural move.
...
Kasparov chooses to force the matter. After this move White has 3 vs 1 
...
Black's bishop pair gives him enough chances to defend.
...
This position should have been foreseen and estimated carefully before Black's 12th move. 
All the moves are forced or natural:
White has a better position. His pieces are better and so is his pawn structure.

Even Kasparov failed to foresee this with his team at home! Maybe we should not be too harsh on ourselves?
...
``An impulsive, nervous reaction, the
...
\mainline[level=1]{ 17.f3 Bf5 }

\chessboard

\mainline[level=1]{18.cxd5
exd5 19.Rxd5 Be6 20.Rd6 Bxa2 21.Rxa6 Rb8 }

\chessboard

\mainline[level=1]{22.Bc5! Re8 23.Bb5! }
...
\begin{itemize}
  ...
  \item{One can make simple natural moves and have the advantage}
\end{itemize}