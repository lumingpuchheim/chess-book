...
\begin{multicols}{2}
    \chessgameinfo{World Championship}{Ding, Liren}{Nepomniachtchi, Ian}{6}{2023.04.15}{1-0}
    \newchessgame[      
        id=main,
    ...
    We have a so-called Carlsbad structure. White has the following typical ideas:
    ...
    \mainline{ 21... Re8 22. Nc5}
    
    \chessboard

    Let's assess the static balance of the position:
    \begin{itemize}
        \item{King Safety}

        Both kings are quite safe.
        \item{Material Correlation}

        The material is completely equal.
        \item{Pawn Structure}

        Pawn structures are similar. Neither part has a clear advantage.
    \end{itemize}

    Black doesn't need to choose dynamic play yet. However, if he 
    chooses a dynamic play, he must estimate the position a few
    moves after his play correctly.

    \mainline{22... e5?} 
    Result of a wrong estimation. 
    Nepo is a dynamic player and he doesn't want to defend passively. Solid play like \variation[invar]{22... Rac8} is better.
    ...
    his plan of countering in the center on his 22nd move. His moves 
    ...
    \mainline[level=1]{ 27... Bc2? }
    Missed an opportunity!
    \variation[invar]{27... Rxe5 28. dxe5 Qd8 \xskakcomment{ This move is hard to see.} 29. Qf3 Qd2 30. hxg6 Qe1+ 31. Kh2 Qxe5+ 32. Kg1 Qe1+ 33. Kh2 Qe5+ 34. g3 \xskakcomment{ Otherwise perpetual check} Qxc5 35. Qxf7+ Kh8 }
    would have saved the game.

    \mainline[level=1]{28. Nxb7 Qb6 29. Nd6 Rxe5 30. Qxe5 Qxb2}
    ...
    Starting a mating attack by cutting of Black king's retreat on e6. 
    
    \mainline{41... a2 42. Qc7 Kh7 43. Ng6 Rg8 44. Qf7 \xskakcomment{ 1-0}}

    \chessboard
    
    Black cannot defend \variation[invar]{45. Qxg8+! Kxg8 46. Ra8+ Kf7 47. Rf8# }
    \variation[invar]{44... Bxg6 45. hxg6+ Kh8 46. Qxg8+! Kxg8 47. Ra8#}
