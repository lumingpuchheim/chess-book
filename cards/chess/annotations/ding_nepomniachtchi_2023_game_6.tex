...
\begin{multicols}{2}
    ...
    Modern chess is full of subtlties. The position is actually a reversed
    Queens Gambit Declined Exchange Variation. Typically after 
    ...
    We will see in this game Ding adopts both Black's idea in Queens Gambit Declined Exchange Variation.  
    Personally I am not a fan of Black's opening. If in Queen's Gambit
    Declined Exchange Variation, Black can defind well. With one more
    tempo and color reversed, White should have some advantage. How can Black still
    defend? 
    ...
    with \symbishop d6 and develop is logical. The next a few moves are natural.
    ...
    \begin{itemize}
        ...
        Not clear, not the rook on a1 or the knight on d2.
        \item{Whas is my opponent's idea?}
    ...
    \mainline{13. a4 a6}
    This move is per se ok. Black starts however a wrong plan that
    his position soon deteriorates.
    ...
    \mainline{16. a5!} We know White's plan already.
    ...
    The queen on c7 is a defender for White's idea. So he tries to exchange it.
    Ding did it skillfully.
    ...
    His position is quite solid.
    
    Nepo choose however an active plan by coutering with e5 in the center. His pieces
    are however too passive for such a dynamic plan. White gets the upper hand soon.
    ...
    Black should have forseen and estimated this position before he started 
    his plan coutering in the center on his 20th move. His moves 
    are forced while White may still have some improvements.

    Who has a better position? Obviously White. He has a full control of 
    ...
    Black has good chance to defend. 
    ...
    Black has weakness on f7. \symrook a5-c5-c7 is natural to attack it.
...
A very deep game played by Ding. He has an advantage in the middle game and 
waits patiently until Nepo took inmature measures.
