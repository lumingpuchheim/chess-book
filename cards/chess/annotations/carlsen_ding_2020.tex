...
\begin{multicols}{2}
    \chessgameinfo{Magnus Carlsen Chess Tour Finals}{Magnus Carlsen}{Ding Liren}{}{2020.11.17}{1-0}
    \newchessgame[
 id=main,
...
\begin{enumerate}
    ...
    Black has a pawn structure similar
    to the French Defence. His light-squared bishop is not active. He could
...
Here is another critical moment.
...
However, Black has a complete pawn structure. He can castle after some moves. So his
position is still defensible.

White intends to play \variation[invar]{10. Qg5}, which threatens the g7 pawn. One option is to play
...
In the game, Ding chooses to play 9... \symknight c6. This move is not bad in itself. 
However, he must play accurately afterwards.
...
let White prove his advantage. Here it is important
