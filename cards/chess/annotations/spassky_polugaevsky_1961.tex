...
After h5 and ...h6, Black protects the g7 pawn and waits for hxg7. In this line, White's rook on g1 would be better placed on h1. 
...
\mainline[level=1]{22. Be5! c4 23. Qe4 Qd5 24. Qg4 c3 25. b3 b4}

\begin{chessdiagram}
    \chessboard
\end{chessdiagram}

Black has created a protected passed pawn. He will have an advantage if he can survive the attack.
...
\mainline[level=1]{26. e4 Qb5+ 27. Ke3 Rf7 28. hxg7 Nf6 29. Bxf6 Rxf6 30. Rxh7}
...
\variation[invar]{
    34. Kf6!! Qxd4 35. Kf7
} Black has no more checks and will be mated. 
...
Spassky should have focused only on the position and played the right move. 
The clock situation was another distraction. Of course, this is easier said than done.

\mainline[level=1]{34. Kh5 Qb5+ 35. Kh4 Be7+
...
} would be a draw. Kasparov failed to point it out in his commentary.

\begin{chessdiagram}
    \chessboard
\end{chessdiagram}

Black finds the right move by \vocab{prophylaxis}{Prophylaxis}{}. He wins the endgame. \index{Prophylaxis}
...
was too difficult to handle. Even Kasparov failed to find the 
