...
\begin{multicols}{2}
    ...
    We can use \vocab{principle-of-choices}{Principle of Choices}{} to find the correct move.
    ...
    a5 is the better move. \index{Principle of Choices}
    ...
    We use \vocab{PoE}{process of elimination}{} to find the correct move. 
    ...
    The position is equal. \index{Process of Elimination}
