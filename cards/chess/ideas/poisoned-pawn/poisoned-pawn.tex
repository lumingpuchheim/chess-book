...
In chess, a poisoned pawn is a pawn that seems to be hanging or undefended, enticing an opponent to capture it. However, doing so often results in a significant positional or material loss due to hidden tactical threats or traps set by the opponent.
