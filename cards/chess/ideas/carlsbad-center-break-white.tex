...
\section{Center Break with f3 and e4 for White in Closed Positions}

\begin{multicols}{2}
    The Carlsbad pawn structure typically arises from the Exchange Variation of the Queen's Gambit, but it can also be reached through openings like the Nimzo-Indian and Caro-Kann. The name comes from the 1923 Carlsbad tournament, where it was prominently featured. 
    ...
    We will illustrate the idea by a famous game.
