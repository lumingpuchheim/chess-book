...
\mainline[level=1]{
    ...
    Such a move is often useful, because it over protects the a2 pawn.

    \variation[invar]{12. f4} is too hasty: \variation{12... e5! 13. Be3 Bg4} White 
    loss an exchange. White must play \variation{13. Nd5 Nxd5 14. exd5 Bb5} and the position is 
    equal.
...
Interestingly, White has also other typical ideas with some amusing variations:
...
We go back to the main line.
\mainline[level=1]{15. f5 b4 16. fxe6 bxc3 17. exf7+ Kh8 18. Rf5 Qb4}

``Reminding White that he too has a vulnerable point b2. In some cases Black has in mind ...\symrook xf7'' (Geller)
\chessboard
...
After \variation{21...Bxf6 21. Qxf6 gxf6 22. Bxf6#}
...
situation was not Fischer's strongest weapon.'' (Geller)
...
White could still have pulled the emergency brake with
...
White resigned because his attack has been parried and he didn't
