...
\else
    \newcommand{\sanakoevLungdalAnswer}[1]{
        ...
        White is leading in development, so he should have the advantage.
        The queen is pinned, so there is no way to start an attack with the queen as usual when one leads in development.

        \variation{1. cxb4 Qxd4 2. Rxd4 Rc2 3. Bd3 Rxb2 4. Rc1 Kd7 5. Rc2 Rxc2 6. Rxc2} Black
