...
\else
 ...
 \chessboard[
	...
	\begin{quote}
		``Now the plan of b2-b4 and Na4 is not all all dangerous to Black, since his own knight will land on c4. Nonetheless Black's scheme has a major defect: he has `shelved' the task of developing his kingside pieces and castling. At that time I had already mastered one of the important law of chess strategy: if one side has fallen behind in development the game must be opened up to punish the offender.'' \cite{Petrosian:2015}
	\end{quote}
    }
\fi
