...
\else
 ...
 \chessboard[
	...
	\begin{itemize}
		...
		The light square bishop does nothing
		\item{Whas is my opponent's idea?}

		He can only wait passively.
	\end{itemize}

	By answering the template question above, the correct move is \symbishop d7, improving the piece as well as exploiting the white's weakness on the main diagonal.
    }
\fi
