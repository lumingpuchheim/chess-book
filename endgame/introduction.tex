...
An important factor in chess, especially in endgame, is the 
ability to analyze a position logically, to think through various plans and schemes.

In some cases, a position is not played as much as it is constructed. First it 
is necessary to determine the configuration of pawns and pieces and only then can we 
proceed with calculation to check whether we can attain the desired configuration.
