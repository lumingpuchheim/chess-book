...
Often in opposite-colored bishop endgames, it is rather constructed than played.
First it is necessary to determine the configuraiton of pawns and pieces which 
...
should place his pawns on the opposite color squares of the bishop while
weaker side must contrary to the general rule, keep his pawns on the same color squares 
as his own bishop. ``A bad bishop protects the good pawns.''

\paragraph{Positional Nuance}
When we are playing an opposite-colored bishop ending, the 
number of pawns are frequently less important than a small alteration 
...
\begin{multicols}{2}
    ...
    White achieves a draw by moving his bishop along h3-c8 diagonal when 
    he is three pawns down. The final position is a \textbf{fortress}.
    White places his pawn on the same color as his own bishop.
