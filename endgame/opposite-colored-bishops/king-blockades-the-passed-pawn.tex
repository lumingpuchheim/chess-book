...
The \vocab{first-defensive-system}{First Defensive System}{
    In an opposite colored bishop endgame, the king blockades the enemy passed pawn while 
...
\begin{multicols}{2}
    ...
    passed pawn. White cannot make any progress. \index{Opposite Colored Bishop Endgame!First Defensive System}

    \mainline[level=1]{
        1. f5 Bd3
    } \textbf{$=$}.

    Breaking down the first defensive system always involves the creation of a second passed pawn, 
    frequently by a pawn breakthrough. \index{Pawn Breakthrough}

    \newchessgame[
        setfen=8/8/4b1p1/2Bp3p/5P1P/1pK1Pk2/8/8 b - - 0 1,
        moveid=1b
    ]
    ...
    and restrains both enemy pawns along the \textbf{one diagonal} a2-g8 (\vocab{one-diagonal-principle}{One Diagonal Principle}{}).

    \index{Bishop Endgame!One Diagonal Principle}
