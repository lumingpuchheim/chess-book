...
\nocite{Dvoretsky:2008-endgame-manual}
...
\input{opposite-colored-bishops/main}
\input{bishop-of-the-same-color/main}
\input{rook-and-pawns/main}
\input{rook-endgame/main}
