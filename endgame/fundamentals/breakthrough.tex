...
Whte wins by \mainline[level=1]{1. b6 cxb6 2. a6 bxa6 3. c6}.
...
This is the structure we find the in Ruy Lopez Exchange Variation.
Black to move can create a passed pawn by 1...c4, followed by 
...c5, ...b4 ...a4 and ...b3.

White to move can play \vocab{prophylaxis}{prophylaxis}{} by 
...
the enemy's doubled pawn to prevent the opponent to create a passed pawn.
...
I call this a ``tetris'', four pawns meet in a tetris. Black 
...
\mainline[level=1]{4. Kb5 f4 5. gxf5 gxh4} the h-pawn queens.
\end{multicols}
