...
% Glossary helper for the term "hanging pawns"
\newcommand{\glsHangingPawns}{\hyperref[gls:hanging-pawns]{hanging pawns}}
...
\chapter*{Glossary}
\markboth{\sffamily\normalsize\bfseries Glossary}{\sffamily\normalsize\bfseries Glossary}
\addcontentsline{toc}{chapter}{\textcolor{ocre}{Glossary}}

\section*{Hanging pawns}\label{gls:hanging-pawns}
In classical terminology, \emph{hanging pawns} are two side‑by‑side pawns
on adjacent files (usually c- and d-pawns or d- and e-pawns) with no pawns
of the same color on neighboring files behind them to support them.
They often give their owner space and dynamic piece activity but can become
long‑term weaknesses if they are blockaded or forced to advance.
