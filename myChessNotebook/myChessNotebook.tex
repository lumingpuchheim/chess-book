...
\newcommand{\titlepage}[3]{%
	...
	\begin{tikzpicture}[remember picture,overlay]%
		...
		\node[anchor=center,align=center] at ([yshift=3cm]current page.center) {\sffamily\Huge\bfseries #2};%
		\node[anchor=center,align=center] at ([yshift=-2cm]current page.center) {\sffamily\huge\bfseries #3};%
	\end{tikzpicture}%
	\restoregeometry%
	\clearpage%
}
