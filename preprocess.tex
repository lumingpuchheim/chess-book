...
% Allow each book to override title/author/subtitle by defining these commands
...
\newcommand{\titlepage}[3]{%
	...
	\begin{tikzpicture}[remember picture,overlay]%
		...
		\ifx\BookSubtitle\empty
			% No subtitle: display title only
			\node[anchor=center,align=center] at ([yshift=3cm]current page.center) {\rmfamily\fontsize{50}{60}\selectfont\bfseries #2};%
		\else
			% Has subtitle: display title and subtitle
			\node[anchor=center,align=center] at ([yshift=5cm]current page.center) {\rmfamily\fontsize{50}{60}\selectfont\bfseries #2};%
			\node[anchor=center,align=center] at ([yshift=2.6cm]current page.center) {\rmfamily\fontsize{50}{60}\selectfont\bfseries \BookSubtitle};%
		\fi
...
% Create a counter for chessboard diagrams
\newcounter{chessboard}
\renewcommand{\thechessboard}{\arabic{chessboard}}

% Create a chessboard environment with automatic numbering
\makeatletter
\newenvironment{chessdiagram}[1][]{%
    \refstepcounter{chessboard}%
    \vspace{2em}%
    \begin{minipage}{\linewidth}%
        \centering%
        \noindent\textcolor{ocre}{\textbf{Diagram~\thechessboard\ifx\relax#1\relax\else\ (#1)\fi}}%
