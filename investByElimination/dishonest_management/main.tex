...
I'm at least not sure if they're exactly true. Real numbers can be like 13.7\%, but not 15\%.


\input{ebita_as_metric/main}

Throughout the earnings call, the focus remained on percentage increases, market share gains, and growth metrics. The company highlighted EBITA improvements across core segments, with Cloud Intelligence Group showing strong EBITA expansion driven by revenue growth. The narrative emphasized EBITA growth rates that outpaced revenue growth, suggesting improved operational efficiency and margin expansion.
