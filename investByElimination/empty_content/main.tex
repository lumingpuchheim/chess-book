\chapter{Empty Content}

In current times, the easiest and first step to estimate a company is to visit its homepage. Bad companies have empty content. We will list some of them.
...
\section*{Too many products / messages}
