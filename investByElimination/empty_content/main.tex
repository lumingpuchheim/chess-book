\chapter{Company Communication: Symptoms}

This chapter lists some symptoms to be found in company communications. These warning signs can help investors identify companies to avoid.

Today, there are different sources of information about a company. The easiest 
and first step to evaluate a company is to visit its homepage. 

Shareholder letters and quarterly reports are other sources of information.

\section{Spelling Errors}

To write well means removing writing errors, bird by bird. This attention to detail matters not just for clarity, but as a signal of a company's broader competence. When a company can't get the basics right in its public communications, it raises questions about its ability to handle more complex matters.

Wirecard provides a striking example. The company's 2018 annual report, a document intended for international investors and regulators, was full of German words like ``Mitarbeiter'' (employees) that had not been translated into English. These were not isolated typos; they were systematic errors that suggested the company had not bothered to properly review or translate its most important public document.

Spelling errors and translation mistakes are trivial to fix. They require only basic attention to detail and a simple review process. Yet Wirecard failed to catch them in a document that represented the company to the world. This failure to handle such trivial matters should be taken seriously: if a company can't get the basics right, it's unlikely to do something more complex. Two years later, Wirecard was insolvent, having collapsed under the weight of a massive accounting fraud.

The lesson is clear: when you see spelling errors, translation mistakes, or other basic errors in a company's official communications—annual reports, investor presentations, or public statements—pay attention. These aren't just cosmetic issues. They signal a lack of attention to detail, a failure of basic quality control, and potentially a deeper problem with how the company operates. A company that can't be bothered to proofread its annual report is unlikely to be rigorous about its financial reporting, product quality, or strategic decisions.

\section{Claims Without Proof}

Some companies make grand claims and then ``prove'' them with irrelevant details. Consider this passage from a real estate company's report:

\begin{quote}
Founded in 1994, Alexandria pioneered this niche and has since established a dominant market presence in AAA locations including Greater Boston, the San Francisco Bay Area, New York City, San Diego, Seattle, Maryland, and Research Triangle Park. Alexandria manages its properties through fully integrated regional teams with unparalleled real estate, science, and technology expertise. Alexandria is known for its high-quality and diverse client tenant base.
\end{quote}

Words like ``dominant market presence'' and ``unparalleled'' sound impressive, but the paragraph gives no evidence for dominance. The fact that a company operates in certain cities, or has a ``diverse'' tenant base, does not prove dominance. Later the report cites occupancy rates, which sound strong, but high occupancy alone does not prove a moat or pricing power. Many landlords can achieve high occupancy in good markets.

As an astute investor, always ask whether a claim is backed up by the facts presented. If the proof is missing—or if the proof is irrelevant—that is a red flag.

\section{Overstressing History}

Some companies lean too heavily on history instead of current performance. Consider this excerpt:
...
History is good, but overstressing it again and again often means the company has lost focus on contemporaries. Past milestones do not prove present advantage. Great companies acknowledge history and then show current results and current execution.
...
\section{Abstract Terms}

Often, abstract words like ``vision'', ``strategy'', ``experience'', ``transformation'', ``innovation'', and ``digitalization'' are warning signals in company communication. These words are not inherently bad; good companies use them too. But there is a crucial difference: good companies replace these abstract terms with concrete content, making the words themselves become superfluous. When a company says it has a ``vision for the future'', you should be able to see specific products, markets, technologies or customer behaviors that make that vision tangible. When a company talks about its ``strategic direction'', you should be able to identify clear actions, investments and trade-offs that demonstrate what that strategy means in practice.
...
Consider a typical corporate statement: ``Our vision is to become a leader in digital transformation by leveraging innovative technologies and strategic partnerships to create value for our stakeholders.'' After reading this, can you answer: What does the company actually do? What specific technologies? Which partnerships? What value? The statement is grammatically correct and uses all the right business terms, but it communicates nothing concrete. It could describe any company in any industry.

This pattern appears frequently in shareholder letters, annual reports, and corporate presentations. When Alibaba acquired Ele.me, the ``New Retail'' vision sounded impressive, but asking ``what specific synergies?'' and ``how will this overcome Meituan's network effects?'' would have revealed the emotional drivers beneath the strategic language. When Nokia described its risks in generic terms, asking ``what about the specific risk of failing to meet customer needs?'' would have exposed the gap between disclosed risks and real threats.
