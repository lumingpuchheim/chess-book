...
To write well means removing writing errors, bird by bird. This attention to detail matters not just for clarity, but as a signal of a company's broader competence. When a company cannot get the basics right in its public communications, it raises questions about its ability to handle more complex matters.
...
Spelling errors and translation mistakes are trivial to fix. They require only basic attention to detail and a simple review process. Yet Wirecard failed to catch them in a document that represented the company to the world. This failure to handle such trivial matters should be taken seriously: if a company cannot get the basics right, it is unlikely to be able to do something more complex. Two years later, Wirecard was insolvent, having collapsed under the weight of a massive accounting fraud.

The lesson is clear: when you see spelling errors, translation mistakes, or other basic errors in a company's official communications—annual reports, investor presentations, or public statements—pay attention. These are not just cosmetic issues. They signal a lack of attention to detail, a failure of basic quality control, and potentially a deeper problem with how the company operates. A company that cannot be bothered to proofread its annual report is unlikely to be rigorous about its financial reporting, its product quality, or its strategic decisions.
