...
Earnings before interest, taxes, and amortization (EBITA) measures a company's profitability and value. As the name implies, EBITA adds interest, taxes, and amortization to the earnings equation. 

Buffett doesn't like EBITDA because it pretends real costs don't exist.

His core objection is that EBITDA ignores depreciation and amortization, which aren't accounting tricks but the economic cost of wearing out assets. A business that needs factories, machines, trucks, or networks must reinvest cash just to stay competitive. EBITDA treats those reinvestments as optional, which inflates how ``cheap'' or ``profitable'' a business looks.
