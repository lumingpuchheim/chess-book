...
\end{figure}
\input{../cards/history/franklin_play_howe}
...
\subsection{Nirvana}
\input{../cards/life/nirvana}
\subsection{How Spassky became World Champion}
\input{../cards/history/spassky}

\section{1984 Karpov - Kasparov World Championship}
\input{../cards/history/kasparov_karpov_match}

\section{Anony of a Winning Position}
\begin{figure}[H] % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	\centering % Horizontally center the figure on the page
	\includegraphics[width=0.5\textwidth]{../cards/history/ivanchuk_cry.png} % Include the figure image
	\caption{Heartbreak after a Game}
	\label{fig:ivanchuk_cry} % Unique label used for referencing the figure in-text
\end{figure}
\input{../cards/history/agony_of_a_winning_position}

\section{``I drank coffee''}
\input{../cards/history/i_drank_coffee}

\section{The Fatal Glance: The Story of Orpheus and Eurydice}
\input{../cards/history/the_fatal_glance}
...
\begin{figure}[H] % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	...
	\label{fig:ding_blunders} % Unique label used for referencing the figure in-text
\end{figure}
\input{../cards/history/ding_lost_wcc} \index{Risk, Uncertainty}

\chapter{Chess and Life}
\section{Life as Chess Game}
\input{../cards/life/life_as_chess_game}
\section{Present Moment}
\input{../cards/life/present_moment}

\section{Meditation}
\input{../cards/life/meditation} \index{Meditation}
\input{../cards/life/meditation_and_chess}


\section{Risk and Uncertainty}
\input{../cards/life/risk_and_uncertainty} \index{Risk, Uncertainty}
\section{Tal's Play}
\input{../cards/history/tal}\index{Risk, Uncertainty}
...
\input{../cards/life/stress}

\section{Hamlet}
\input{../cards/life/hamlet}
...
\input{../cards/life/chess_and_computer}

\section{Perception and Decision Stages}
\input{../cards/life/perception} \index{Chess Perception}

\section{Chunk}
\input{../cards/life/chunks} \index{Chunks}
\subsection{Daedalus and the Labyrinth}
\input{../cards/life/daedalus}

\section{Satisficing}
\input{../cards/life/satisficing} \index{Satisficing}
\section{Heuristic} \index{Heuristics}
\input{../cards/life/heuristic}

\subsection{Heuristic in Life} \index{Heuristics!Life}
\input{../cards/life/heuristic_in_life}

\subsection{Heuristic in Chess} \index{Heuristics!Chess}
\input{../cards/life/heuristic_in_chess}
...
\input{../cards/chess/schematic_thinking}
...
\input{../cards/chess/thinking_template}
...
\input{../cards/chess/process_of_elimination/elimination_tool}
\input{../cards/chess/process_of_elimination/karjakin-carlsen-2013}
\input{../cards/chess/process_of_elimination/lelchuk-voronova}
\input{../cards/chess/process_of_elimination/tal-keller}
...
\input{../cards/chess/critical_position/dynamic-chess-problem}
\section{Critical Position}
\input{../cards/chess/critical_position}
\section{How to play a Critical Position} \label{sec:critical-position}
\input{../cards/chess/chess_method}

\input{../cards/chess/critical_position/short-sokolov}
\input{../cards/chess/critical_position/ding-gukesh-game12}
\input{../cards/chess/critical_position/nielsen-dreev}
\input{../cards/chess/critical_position/ding-nepomniachtchi_game4}
\input{../cards/chess/critical_position/arnason-miles}
\input{../cards/chess/critical_position/miles}
...
\chapter{Side Lines}
\input{../cards/chess/playouts/tactical/ding-gukesh-game12}
\input{../cards/chess/playouts/tactical/lelchuk-voronova}
...
\chapterimage{../Images/orange2.jpg} % Chapter heading image
