...
\titlepage % Output the title page
	...
	{ % Title(s) and author(s)
		...
		{\Huge\bfseries Finding Inner Peace Through the Game of Chess\par} % Book title
...
\section{Satisficing}
\input{cards/life/satisficing}
\section{Heuristic}
\input{cards/life/heuristic}

\subsection{Heuristic in Life}
\input{cards/life/heuristic_in_life}

\subsection{Heuristic in Chess}
\input{cards/life/heuristic_in_chess}

%\part{Let's play some Chess}
\chapter{Simple Chess}
Most chess books on the market are filled with endless variations. Yet for any human being, it is impossible to calculate all those lines, visualize every position, and then evaluate them accurately. Use such analysis as a standard only leads to frustration and stress.
