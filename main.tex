...
\section{Process of Elimination} \index{Thinking!Process of Elimination}
...
\chapter{Complex Exercises}

In this chapter, we will present some complex exercises. To solve these exercises, you must use the thinking tools we have covered in the previous chapters: Prophylaxis, Process of Elimination, and the Three Questions for assessing a position. You may need to calculate a little, but you don't need to calculate through the whole variation.
...
\input{cards/chess/dynamic/dynamic-chess-problem}
...
\input{cards/chess/dynamic/short-sokolov}
\input{cards/chess/dynamic/ding-gukesh-game12}
...
\chapter{Side Lines}
\input{cards/chess/tactical/ding-gukesh-game12}
