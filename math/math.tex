...
\def\BookTitle{Cracking Lottery}
...
\input{general_test_procedure}
\input{empirical_tests}
\input{frequency_test}
\input{serial_test}
\input{vertical_serial_test}
\input{coupon_collector_test}
