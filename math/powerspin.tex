...
If a prediction is correct, the stake is multiplied by the corresponding multiplier shown in the official PowerSpin payout table. :contentReference[oaicite:0]{index=0}
