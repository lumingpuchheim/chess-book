...
the total number \(\varphi(n)\) is n minus number of the multiples of \(p_i\), i=1,2,\dots,r,
plus the number ofmultiples of \(p_i\) \(p_j\), i,j=1,2,\dots,r, minus number of the multiples of 
